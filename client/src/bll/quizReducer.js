...
const quizSlice = createSlice({
    ...
    reducers: {
        changeData: (state, action) => {
            state.quiz[action.payload.objNumber].attributes.quest[action.payload.questionNumber].options = state.quiz[action.payload.objNumber].attributes.quest[action.payload.questionNumber].options.map((t) =>
